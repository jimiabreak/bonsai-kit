...
export default function InfoPage() {
  ...
  return (
    <div
      style={{ "--background": "#152885" } as React.CSSProperties}
      className="min-h-[100dvh] w-full overflow-x-hidden bg-[var(--background)]"
    >
      {/* Header */}
      ...
      <div className="max-w-[1008px] mx-auto px-4 md:px-8 pt-16 md:pt-24 pb-20 w-full">
        ...
        >
          ...
          <div className="text-cream">
            <h2 className="text-title mb-6 md:mb-8 text-center md:text-right">
              HOURS
            </h2>
